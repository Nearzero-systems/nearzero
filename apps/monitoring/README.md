# Nearzero Monitoring (Go Version)

**Powered by Nearzero (Nearzero.dev)**

Application that powers Nearzero's monitoring service.
...
Nearzero uses a callback URL to send notifications when metrics exceed configured thresholds. Notifications are sent via POST request in the following format:
