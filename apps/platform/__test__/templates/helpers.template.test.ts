import type { Schema } from "@nearzero/server/templates";
import { processValue } from "@nearzero/server/templates/processors";
...
describe("helpers functions", () => {
	...
	describe("${jwt}", () => {
		it("should generate a JWT string", () => {
			...
			expect(decodedPayload.iss).toEqual("nearzero");
		});
		it.each([6, 8, 12, 16, 32])(
