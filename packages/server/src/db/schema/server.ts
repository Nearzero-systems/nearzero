...
export type ServerSetupStatus = "not_started" | "running" | "ready" | "failed";
...
export const server = pgTable("server", {
	...
	setupStatus: text("setupStatus")
		.$type<ServerSetupStatus>()
		.notNull()
		.default("not_started"),
	setupError: text("setupError"),
	setupStartedAt: text("setupStartedAt"),
	setupFinishedAt: text("setupFinishedAt"),
...
export const apiRemoveServer = createSchema
	...
	.required()
	.extend({
		deleteAttachedServices: z.boolean().optional().default(false),
	});
