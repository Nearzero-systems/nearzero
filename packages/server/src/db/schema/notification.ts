...
export const notifications = pgTable("notification", {
	...
	nearzeroRestart: boolean("nearzeroRestart").notNull().default(false),
	nearzeroBackup: boolean("nearzeroBackup").notNull().default(false),
...
export const apiUpdatePushover = z.object({
	...
	nearzeroBackup: z.boolean().optional(),
	volumeBackup: z.boolean().optional(),
	nearzeroRestart: z.boolean().optional(),
