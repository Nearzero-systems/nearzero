...
import WelcomeEmail from "../emails/emails/welcome";
...
export const sendInvitationEmail = async ({
	...
	await sendTransactionalEmail({
		to: email,
		subject: `You've been invited to join ${organizationName} on Nearzero`,
		html,
	});
};
...
export const sendWelcomeEmail = async ({
	...
	await sendTransactionalEmail({
		to: email,
		subject: `Welcome to Nearzero, ${firstName || "there"}`,
		html,
	});
};
